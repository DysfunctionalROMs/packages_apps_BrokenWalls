...
public class brokenwalls extends Activity implements AdapterView.OnItemSelectedListener,
        OnClickListener {
    ...
    private void findWallpapers() {
        mThumbs = new ArrayList<Integer>(36);
        mImages = new ArrayList<Integer>(36);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        ImageAdapter(brokenwalls context) {
